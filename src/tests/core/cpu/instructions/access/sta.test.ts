...
describe("STA instruction integration tests", () => {
  ...
  // Helper para carregar programa e definir PC
  ...
  it("STA zero page stores accumulator", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_ZERO_PAGE, 0x10]);
    cpu.step();
  ...
  it("STA zero page X stores accumulator with X offset", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_ZERO_PAGE_X, 0x10]);
    cpu.step();
  ...
  it("STA absolute stores accumulator", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_ABSOLUTE, 0x00, 0x20]);
    cpu.step();
  ...
  it("STA absolute X stores accumulator", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_ABSOLUTE_X, 0x00, 0x20]);
    cpu.step();
  ...
  it("STA absolute Y stores accumulator", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_ABSOLUTE_Y, 0x00, 0x20]);
    cpu.step();
  ...
  it("STA (indirect,X) stores accumulator", () => {
    ...
    loadProgram([Opcode.STORE_ACCUMULATOR_INDIRECT_X, 0x10]);
  ...
  it("STA (indirect),Y stores accumulator", () => {
    ...
    // Instrução + base zero page
    loadProgram([Opcode.STORE_ACCUMULATOR_INDIRECT_Y, 0x10]);
