...
describe("STX instruction integration tests", () => {
  ...
  it("STX zero page stores X", () => {
    ...
    loadProgram([Opcode.STORE_X_REGISTER_ZERO_PAGE, 0x10]);
    cpu.step();
  ...
  it("STX zero page Y stores X with Y offset", () => {
    ...
    loadProgram([Opcode.STORE_X_REGISTER_ZERO_PAGE_Y, 0x10]);
    cpu.step();
  ...
  it("STX absolute stores X", () => {
    ...
    loadProgram([Opcode.STORE_X_REGISTER_ABSOLUTE, 0x00, 0x20]);
    cpu.step();
