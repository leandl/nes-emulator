...
describe("TAX instruction integration tests", () => {
  ...
  it("TAX transfers Accumulator to X and updates flags", () => {
    ...
    loadProgram([Opcode.TRANSFER_ACCUMULATOR_TO_X_REGISTER]);
    cpu.step();
    ...
    loadProgram([Opcode.TRANSFER_ACCUMULATOR_TO_X_REGISTER], 0x8001);
    cpu.step();
    ...
    loadProgram([Opcode.TRANSFER_ACCUMULATOR_TO_X_REGISTER], 0x8002);
    cpu.step();
